(function(app){
	app.factory('socketFactory', ['toolsFactory', 'valuesFactory', function(toolsFactory, valuesFactory){
        var socketFact = {};
        
        socketFact.socket = io();
        
        socketFact.start = function(info) {
            info.values = valuesFactory.getAll();
        ...
        socketFact.startListening = function() {
            socketFact.socket.on('startdraw', function (msg) {
                ...
                valuesFactory.setAll(info.values);
